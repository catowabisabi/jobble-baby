#!/bin/bash
# Dispatch cycle 347 — Register reflex-visual-motor tab in _layout.tsx
set -e
cd /mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/JobbleBaby

TASK_FILE="/mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/.hermes/autoloop/sisyphus_task_347.txt"
PROMPT=$(cat <<'PROMPT'
# Todo #347: Register reflex-visual-motor tab in _layout.tsx
# Status: DISPATCHED
...
EOF" Enter
sleep 2
tmux send-keys -t jobble-baby "cat /mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/.hermes/autoloop/sisyphus_task_347.txt" Enter
sleep 3
tmux send-keys -t jobble-baby "bash /mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/.hermes/autoloop/_dispatch_347.sh" Enter
