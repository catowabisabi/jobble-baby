#!/usr/bin/env python3
"""Dispatch Bottle Feeding Navigator task to Sisyphus via tmux"""
import subprocess
import time
import os
...
time.sleep(0.3)
# Send keywords
subprocess.run(["tmux", "send-keys", "-t", session, "Keywords: feeding_rhythm_entrainment, teething_biscuits, reference_population"])
subprocess.run(["tmux", "send-keys", "-t", session, ""])
time.sleep(0.2)
# Send ULW
