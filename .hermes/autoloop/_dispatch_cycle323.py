#!/usr/bin/env python3
"""
Sisyphus Cycle 323 Task: Write Concept Spec — Dyadic Synchrony Playground
"""
import os

REPO = "/mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/JobbleBaby"
TASK_FILE = "/mnt/c/Users/enoma/Desktop/opencode-work/agent-works/jobble-baby/.hermes/autoloop/sisyphus_task_cycle323.txt"
os.chdir(REPO)
...
# Extract just the task description (skip the cd line and the ULW marker)
...
# Write the concept spec
spec_path = os.path.join(REPO, 'docs/concepts/dyadic-synchrony-playground.md')
os.makedirs(os.path.dirname(spec_path), exist_ok=True)

spec = """# Dyadic Synchrony Playground — Concept Spec
...
print(f"Concept spec written: {spec_path}")

# Add i18n keys
import json
en_path = os.path.join(REPO, 'app/i18n/en.json')
zh_path = os.path.join(REPO, 'app/i18n/zh.json')
...
i18n_keys = {
    "title": "Dyadic Synchrony Playground",
    "activityLibrary": "Activity Library",
    "startSession": "Start Session",
    "sessionTimer": "Session Timer",
    "synchronyScore": "Synchrony Score",
    "dualTracking": "Dual Tracking",
    "progressChart": "Progress Chart",
    "tipsLibrary": "Tips Library",
    "parentBaseline": "Parent Baseline",
    "babyBaseline": "Baby Baseline",
    "excellentSynchrony": "Excellent synchrony — both trending together",
    "goodCoRegulation": "Good co-regulation",
    "moderateDivergence": "Moderate divergence",
    "lowSynchrony": "Low synchrony — consider calmer environment",
    "eyeGaze": "Eye-Gaze Game",
    "synchronizedBreathing": "Synchronized Breathing",
    "faceMirroring": "Face Mirroring",
    "coRegulatedRocking": "Co-Regulated Rocking",
    "sharedHumming": "Shared Humming",
    "skinToSkin": "Skin-to-Skin Heartbeat",
    "minutes3": "3 minutes",
    "minutes5": "5 minutes",
    "minutes10": "10 minutes"
}

en['dyadicSynchrony'] = i18n_keys
zh['dyadicSynchrony'] = {k: v for k, v in i18n_keys.items()}  # same for zh for now
...
print(f"i18n keys added: {len(i18n_keys)}")

# Verify TSC
import subprocess
result = subprocess.run(['npx', 'tsc', '--noEmit'], cwd=REPO, capture_output=True, text=True)
