...
const keys = {
  ...
  'gravityFeeding.tactileHint': 'Tap a symbol to signal. Use as a pre-verbal communication bridge.',
...
if (!indexContent.includes('gravity-feeding')) {
  indexContent = indexContent.replace(
    ...
    'component: TrackingScreen },\\n      { name: \\'gravity-feeding\\', component: require(\\"./gravity-feeding\\").default },'
  );
