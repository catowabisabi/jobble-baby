          ...
          <View style={[styles.modal, { backgroundColor: card }]}>
            ...
            {selectedReflex && (
              <>
                ...
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('reflex.datePlaceholder')} placeholderTextColor="#9CA3AF" value={selectedReflex.date} onChangeText={v => setSelectedReflex({ ...selectedReflex, date: v })} />
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('reflex.notesPlaceholder')} placeholderTextColor="#9CA3AF" value={selectedReflex.notes} onChangeText={v => setSelectedReflex({ ...selectedReflex, notes: v })} />
                  <View style={styles.modalBtns}>
                    <TouchableOpacity style={styles.cancelBtn} onPress={() => setModalReflex(false)} accessibilityLabel={t('reflex.cancel')}><Text style={{ color: text }}>{t('reflex.cancel')}</Text></TouchableOpacity>
          ...
          <View style={[styles.modal, { backgroundColor: card }]}>
            ...
            {selectedVisual && (
              <>
                ...
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('visual.datePlaceholder')} placeholderTextColor="#9CA3AF" value={selectedVisual.date} onChangeText={v => setSelectedVisual({ ...selectedVisual, date: v })} />
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('visual.notesPlaceholder')} placeholderTextColor="#9CA3AF" value={selectedVisual.notes} onChangeText={v => setSelectedVisual({ ...selectedVisual, notes: v })} />
                  <View style={styles.modalBtns}>
                    <TouchableOpacity style={styles.cancelBtn} onPress={() => setModalVisual(false)} accessibilityLabel={t('reflex.cancel')}><Text style={{ color: text }}>{t('reflex.cancel')}</Text></TouchableOpacity>
          ...
          <View style={[styles.modal, { backgroundColor: card }]}>
            ...
            {selectedSkinfold && (
              <>
                ...
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('skinfold.mmPlaceholder')} placeholderTextColor="#9CA3AF" keyboardType="numeric" value={selectedSkinfold.mm > 0 ? String(selectedSkinfold.mm) : ''} onChangeText={v => setSelectedSkinfold({ ...selectedSkinfold, mm: parseInt(v) || 0 })} />
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('skinfold.datePlaceholder')} placeholderTextColor="#9CA3AF" value={selectedSkinfold.date} onChangeText={v => setSelectedSkinfold({ ...selectedSkinfold, date: v })} />
                <TextInput style={[styles.input, { backgroundColor: bg, color: text }]} placeholder={t('skinfold.notesPlaceholder')} placeholderTextColor="#9CA3AF" value={selectedSkinfold.notes} onChangeText={v => setSelectedSkinfold({ ...selectedSkinfold, notes: v })} />
                  <View style={styles.modalBtns}>
                    <TouchableOpacity style={styles.cancelBtn} onPress={() => setModalSkinfold(false)} accessibilityLabel={t('reflex.cancel')}><Text style={{ color: text }}>{t('reflex.cancel')}</Text></TouchableOpacity>
