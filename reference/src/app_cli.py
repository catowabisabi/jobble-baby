...
def main() -> None:
    """Run the Streamlit dashboard using direct import."""
    # Import streamlit and main application directly
    try:
        import streamlit.web.cli as stcli
    except ImportError as e:
        print(f"Error: Streamlit is not installed. {e}")
        sys.exit(1)
    ...
    # Run streamlit using its CLI entry point directly
    sys.argv = ["streamlit", "run", str(main_path.resolve())]
    stcli.main()
